...
dataModel = "DeviceMeasurement"
subject = "dataModel.Device"
controlledProperty = "{'type': 'Property', 'value': 'humidity'}"
attribute = "controlledProperty"
value = controlledProperty
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

dateObserved = "{'type': 'Property', 'value': '2021-09-03T07:33:18Z'}"
attribute = "dateObserved"
value = dateObserved
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

deviceType = "{'type': 'Property', 'value': 'sensor'}"
attribute = "deviceType"
value = deviceType
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

measurementType = "{'type': 'Property', 'value': 'FillingLevelSensor'}"
