...
class Type6(Enum):
    SmartMeteringObservation = 'SmartMeteringObservation'


class SmartMeteringObservation(BaseModel):
    ...
    entityVersion: Optional[EntityVersion] = Field(
        None,
    ...
    offPeakConsumption: Optional[float] = Field(
        None,
    ...
    peakConsumption: Optional[float] = Field(
        None,
    ...
    totalConsumption: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='It has to be SmartMeteringObservation. NGSI entity type'
    )
