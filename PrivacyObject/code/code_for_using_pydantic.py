...
class PrivacyObject(BaseModel):
    ...
    crossborderTransfer: Optional[str] = Field(
        None,
    ...
    purpose: Optional[str] = Field(None, description='Purpose of the data gathering')
    recipientList: Optional[List[AnyUrl]] = Field(
        None,
    ...
    ] = Field(None, description='Unique identifier from the source data set')
    retentionPeriod: Optional[str] = Field(None, description='Period of data retention')
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type property. It has to be PrivacyObject'
    )
    user: Optional[AnyUrl] = Field(
        None,
